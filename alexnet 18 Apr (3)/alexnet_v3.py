...
train_datagen = ImageDataGenerator(dtype='uint16') #samplewise_center = True, samplewise_std_normalization = True, featurewise_center = True, featurewise_std_normalization = True)
